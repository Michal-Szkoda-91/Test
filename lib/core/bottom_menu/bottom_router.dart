...
List<BartMenuRoute> subRoutes() {
  return [
    BartMenuRoute.bottomBar(
      ...
      icon: Icons.home,
      path: 'home',
      pageBuilder: (_, __, settings) => const HomePage(),
    ...
    BartMenuRoute.bottomBar(
      ...
      icon: Icons.favorite,
      path: 'wishlist',
      pageBuilder: (_, __, settings) => const PageFake(),
      transitionDuration: bottomBarTransitionDuration,
      transitionsBuilder: bottomBarTransition,
    ),
    BartMenuRoute.bottomBarBuilder(
      ...
      path: 'notifications',
      pageBuilder: (_, __, settings) => NotificationsPage(),
      transitionDuration: bottomBarTransitionDuration,
      transitionsBuilder: bottomBarTransition,
    ),
    BartMenuRoute.bottomBar(
    ...
    BartMenuRoute.innerRoute(
      path: 'search',
      pageBuilder: (_, __, ___) => const PageFake(),
    ),
    BartMenuRoute.innerRoute(
