...
import 'package:apparence_kit/modules/notifications/ui/components/notifications_header.dart';
            ...
            slivers: [
              const SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: NotificationsHeader(
                    paddingHeight: 32,
                  ),
                  // collapseMode: CollapseMode.parallax, <- this is the default
                ),
              ),
              SliverPadding(
