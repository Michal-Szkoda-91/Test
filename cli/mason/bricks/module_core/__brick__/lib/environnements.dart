    ...
    switch (_kEnvironmentInput) {
      case 'dev':
        return const Environment.dev(
          ...
          {{#anonymous_auth}}authenticationMode: AuthenticationMode.anonymous,{{/anonymous_auth}}
          {{^anonymous_auth}}authenticationMode: AuthenticationMode.authRequired,{{/anonymous_auth}}
        );
      case 'prod':
